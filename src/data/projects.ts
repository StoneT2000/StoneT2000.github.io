export const ProjectsData = {
  ...
  'rl-ts': {
    ...
    Implements a OpenAI Gym style interface and enables users to create gym environments with stronger typing, less bugs, and nicer visuals. 
  ...
  polytomizator: {
    ...
    thumbnailAltText:
      'Art generated by Polytomizator',
